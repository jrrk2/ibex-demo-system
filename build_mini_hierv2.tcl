...
# gate-mapped HIERARCHICAL Verilog (ibex_mini_hier_novstub.v — real UNISIM cells,
...
#
#   verilog in : /tmp/svs_ibex_mini/ibex_mini_hier_novstub.v   (HIER_VERILOG=1 emit)
...
create_project -force -in_memory ibex_mini_hierv2 -part $part
read_verilog -sv /tmp/svs_ibex_mini/ibex_mini_hier_novstub.v
...
place_design
route_design
write_checkpoint -force /tmp/ibex_mini_hierv2.dcp
write_bitstream -force /tmp/ibex_mini_hierv2.bit
report_utilization -file /tmp/ibex_mini_hierv2_util.rpt
report_timing_summary -file /tmp/ibex_mini_hierv2_timing.rpt -max_paths 5
